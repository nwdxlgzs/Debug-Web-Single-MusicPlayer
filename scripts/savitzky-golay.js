// https://github.com/mljs/savitzky-golay-generalized/blob/c2614a9d6b378ac0580637fc27e60788177e9587/src/index.js

/**
 * Apply Savitzky Golay algorithm
 * @param {number[]} [ys] Array of y values
 * @param {number[]|number} [xs] Array of X or deltaX
 * @param {object} [options={}]
 * @param {number} [options.windowSize=9]
 * @param {number} [options.derivative=0]
 * @param {number} [options.polynomial=3]
 * @return {number[]} Array containing the new ys (same length)
 */
